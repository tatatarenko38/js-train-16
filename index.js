...
function filterStudentsByGrade(students, grade) {
  ...
  const filterStudent = students.filter((student) => student.grade === grade);
...
function compareArrays(arr1, arr2) {
  ...
  const sortArr1 = arr1.sort((elem1, elem2) => elem1 - elem2);
  const sortArr2 = arr2.sort((elem1, elem2) => elem1 - elem2);
  const result = JSON.stringify(sortArr1) === JSON.stringify(sortArr2);
...
function validateUserInput(userInput) {
  ...
  const hasName = userInput.hasOwnProperty("username");
  console.assert(hasName, "Помилка: ім'я користувача відсутнє!");
  const hasPass = userInput.hasOwnProperty("password");
  console.assert(hasPass, "Помилка: пароль відсутній!");
...
function countVowelsAndConsonants(word) {
  ...
  console.log("Голосних:", a, "Приголосних:", b)
}
